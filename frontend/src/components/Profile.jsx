...
const Profile = () => {
    ...
    if (!user || !user.profile) {
        return <div>Loading...</div>; // You can handle loading differently if necessary
    }
